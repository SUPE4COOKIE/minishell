...
/*   Updated: 2024/08/14 11:19:31 by scrumier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			copy_value(char **result, char **value, size_t *iter, \
				size_t *i);
...
int				get_var_value(t_lexer **lex, char **var, size_t *i, \
				char **envp);
...
int				var_manager(t_lexer **lex, size_t *i, char **var, \
...
int				process_word(t_lexer **lex, char *line, size_t start, \
				size_t end);
int				handle_quotes(t_lexer **lex, size_t *start, size_t *end, \
				char *line);
int				handle_operator(t_lexer **lex, size_t *start, size_t *end, \
				char *line);
int				lexer_director(t_lexer **lex, size_t *end, size_t *start, \
				char *line);
int				finalize_lexer(t_lexer **lex, char *line, size_t start, \
				size_t end);
...
void			is_redir_reference(char *redir, char *reference, \
